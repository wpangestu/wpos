    ...
    <div class="box box-default" style="margin-bottom: 10px">
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-3">
              <form action="<?= base_url('report/sell_daily') ?>" method="post">
            ...
            <tbody>
              <?php if ($sales->num_rows() > 0) : ?>
                ...
                <tfoot>
                  ...
                  <tr>
                  <td colspan="7">
                      <a href="<?= base_url('report/print_sale_dialy?start='.$startdate.'&end='.$enddate) ?>" target="_blank"class="btn bg-maroon"><i class="fa fa-print"></i> Print Pdf</a>
                      <a href="<?= base_url('report/excel_sale_dialy?start='.$startdate.'&end='.$enddate) ?>" type="submit" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export Excel</a>
                  </td>
                </tr>
                </tfoot>
              <?php else : ?>
