...
<div class="col-md-12">
  <div class="box box-default">
    ...
    <div class="box-body">
      <a href="<?= base_url('transaksi/stokin/tambah') ?>" class="btn <?= btncolor(getsetting()->theme) ?>" style="margin-bottom: 7px"><i class="fa fa-plus-square"></i> Tambah</a>
...
<div class="modal-dialog modal-md">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title">Detail Stok In</h4>
    </div>
