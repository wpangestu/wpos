  ...
  <div class="col-md-12">
    <div class="box box-default">
      <div class="box-header with-border">
        ...
        <a href="<?= base_url('transaksi/stokout') ?>" class="text-dark"><i class="fa fa-arrow-left"></i></a>
          <?= $sub_title ?>
        </h3>
      </div>
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-md-4">
            <form action="<?= base_url('transaction/process_stockout_add') ?>" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input name="kodebarang" required type="text" placeholder="Type Kode Barang" class="form-control pull-right" id="kodebarang">
              ...
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <textarea name="detail" required id="detail" class="form-control" cols="30" rows="2" placeholder="ex: Barang rusak, hilang, kedaluarsa, ..."></textarea>
                  </div>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group pull-right">
                ...
                <a href="<?= base_url('transaction/stock_out') ?>" class="btn btn-default btn-md">Kembali</a>
              </div>
            </form>
          </div>
          <div class="col-md-4"></div>
